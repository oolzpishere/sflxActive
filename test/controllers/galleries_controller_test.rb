...
class GalleriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create gallery" do
    assert_difference('Gallery.count') do
      post galleries_url, params: { gallery: { body: @gallery.body, photos: @gallery.photos, position: @gallery.position, side_body: @gallery.side_body, title: @gallery.title } }
    end
  ...
  test "should update gallery" do
    patch gallery_url(@gallery), params: { gallery: { body: @gallery.body, photos: @gallery.photos, position: @gallery.position, side_body: @gallery.side_body, title: @gallery.title } }
